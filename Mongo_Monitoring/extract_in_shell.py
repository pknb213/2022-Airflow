...
# client = MongoClient("mongodb://localhost:30001,localhost:30002,localhost:30003/?replicaSet=configSet&w=majority")
client = MongoClient("mongodb://localhost:50001,localhost:50002,localhost:50003/?replicaSet=configSet")
db = client.test
coll = db.testcoll
